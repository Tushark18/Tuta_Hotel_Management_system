...
def date(c):
    if c[2] >= 2022 and c[2] <= 3000:
        if c[1] != 0 and c[1] <= 12:
            if c[1] == 2 and c[0] != 0 and c[0] <= 29:
...
def Booking():
    ...
    # if-conditions to display allotted room type and its price
    if ch == 0:
        print(" 1. Standard Non-AC - Rs. 500")
        print(" 2. Standard AC - Rs. 2000")
        print(" 3. 3-Bed Non-AC - Rs. 1500")
...
def Rooms_Info():
    ...
    print("an attached washroom with hot/cold water, Window AC.\n")
...
def restaurant():
    ...
    for n in range(0, i):
        if custid[n] == ph and p[n] == 0:
            ...
            while ch != 0:
                ch = int(input(" -> "))
                # if-elif-conditions to assign item prices listed in the menu card
        ...
        if ph == phno[n]:
            ...
            if p[n] == 0:
                ...
                if ch == 'y' or ch == 'Y':
                    ...
                    p.pop(n)
                    p.insert(n, 1)
                    # pops room no. and customer id from the list and later assigns zero at the same position
                    roomno.pop(n)
                    custid.pop(n)
                    roomno.insert(n, 0)
                    custid.insert(n, 0)
